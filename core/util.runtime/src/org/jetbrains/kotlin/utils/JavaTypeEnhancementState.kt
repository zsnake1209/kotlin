...
class JavaTypeEnhancementState(
    ...
    val codeAnalysisReportLevel: ReportLevel = DEFAULT_REPORT_LEVEL_FOR_CODE_ANALYSIS
) {
    ...
    val disabledJsr305: Boolean =
        globalJsr305Level == ReportLevel.IGNORE && migrationLevelForJsr305 == null && userDefinedLevelForSpecificJsr305Annotation.isEmpty()

    val disabledDefaultAnnotations = disabledJsr305 || codeAnalysisReportLevel == ReportLevel.IGNORE
