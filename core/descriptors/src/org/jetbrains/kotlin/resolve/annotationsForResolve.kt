...
val LOW_PRIORITY_RESOLUTION_KEY = object : CallableDescriptor.UserDataKey<Unit> {}
...
fun CallableDescriptor.hasLowPriorityInOverloadResolution(): Boolean =
    getUserData(LOW_PRIORITY_RESOLUTION_KEY) != null || annotations.hasAnnotation(LOW_PRIORITY_IN_OVERLOAD_RESOLUTION_FQ_NAME)
