...
object OperatorNameConventions {
    ...
    @JvmField
    val ALL_OPERATION_NAMES: Set<Name> = setOf(
        GET_VALUE, SET_VALUE, PROVIDE_DELEGATE,
        EQUALS, COMPARE_TO, CONTAINS, INVOKE, ITERATOR, GET, SET, NEXT, HAS_NEXT,
        AND, OR,
        INC, DEC, PLUS, MINUS, NOT,
        UNARY_MINUS, UNARY_PLUS,
        TIMES, DIV, MOD, REM, RANGE_TO,
        TIMES_ASSIGN, DIV_ASSIGN, MOD_ASSIGN, REM_ASSIGN, PLUS_ASSIGN, MINUS_ASSIGN
    )
}
