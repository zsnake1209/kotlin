...
internal class Checks private constructor(
    ...
    private val additionalCheck: (FunctionDescriptor) -> String?,
    private vararg val checks: Check
) {
...
object InfixChecks : AbstractModifierChecks() {
    override val checks = listOf(
        Checks(MemberOrExtension, SingleValueParameter, NoDefaultAndVarargsCheck)
    )
}
