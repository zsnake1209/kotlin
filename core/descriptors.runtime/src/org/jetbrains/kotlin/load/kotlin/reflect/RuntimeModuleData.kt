...
import org.jetbrains.kotlin.load.java.NullabilityAnnotationsPolicy
...
class RuntimeModuleData private constructor(
    ...
    companion object {
        fun create(classLoader: ClassLoader): RuntimeModuleData {
            ...
            val annotationTypeQualifierResolver = AnnotationTypeQualifierResolver(storageManager, NullabilityAnnotationsPolicy.IGNORE)
