...
import org.jetbrains.kotlin.contracts.contextual.parsing.PsiContextualContractsParserDispatcher
...
import org.jetbrains.kotlin.contracts.contextual.resolution.collectDefiniteInvocationsOfContextualContracts
...
class ContractsImplementationExtension : ContractsExtension {
    ...
    override fun getPsiParserDispatcher(
        ...
        PsiContextualContractsParserDispatcher(collector, callContext, dispatcher)
    ...
    override fun collectDefiniteInvocations(
        ...
        collectDefiniteInvocationsOfContextualContracts(effect, resolvedCall, bindingContext)
