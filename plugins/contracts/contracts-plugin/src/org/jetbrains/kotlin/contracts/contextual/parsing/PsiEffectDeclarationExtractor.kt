...
import org.jetbrains.kotlin.contracts.contextual.model.ContextEntityDeclaration
...
fun ContextDeclarations.toList(): List<ContextEntityDeclaration<*>> = listOfNotNull(provider, verifier, cleaner)