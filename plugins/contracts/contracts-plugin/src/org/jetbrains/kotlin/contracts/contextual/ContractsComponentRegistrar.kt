...
class ContractsComponentRegistrar : ComponentRegistrar {
    ...
    override fun registerProjectComponents(project: MockProject, configuration: CompilerConfiguration) {
        ...
        // TODO: replace `extensionPointName.name` with `extensionPointName` after drop 182 idea
        if (!extensionsArea.hasExtensionPoint(SpecificContractExtension.extensionPointName.name)) {
            this::class.java.classLoader.getResourceAsStream("META-INF/plugin.xml")?.let { pluginXmlUrl ->
