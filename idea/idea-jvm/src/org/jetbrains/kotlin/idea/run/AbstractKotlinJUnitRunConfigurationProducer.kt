...
abstract class AbstractKotlinJUnitRunConfigurationProducer<T : JUnitConfiguration>(configurationType: JUnitConfigurationType) :
    ...
    private fun settingsMatchTemplate(configuration: T, context: ConfigurationContext): Boolean {
