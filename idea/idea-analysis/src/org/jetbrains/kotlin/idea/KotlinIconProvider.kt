...
import org.jetbrains.kotlin.idea.util.isActualDeclaration
...
class KotlinIconProvider : IconProvider(), DumbAware {
    override fun getIcon(psiElement: PsiElement, flags: Int): Icon? {
        ...
        val result = psiElement.getBaseIcon()?.addExpectActualMarker(psiElement)
...
private fun Icon.addExpectActualMarker(element: PsiElement): Icon {
    ...
    val additionalIcon = when {
        ...
        declaration.isActualDeclaration() -> ACTUAL
        else -> return this
    }
