...
public class LocalInspectionTestGenerated extends AbstractLocalInspectionTest {
    ...
    public static class Fir extends AbstractLocalInspectionTest {
        ...
        public void testAllFilesPresentInFir() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/inspectionsLocal/fir"), Pattern.compile("^([\\w\\-_]+)\\.(kt|kts)$"), true);
        }
        ...
        public static class TypeFromNestedClass extends AbstractLocalInspectionTest {
            ...
            public void testAllFilesPresentInTypeFromNestedClass() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/inspectionsLocal/fir/typeFromNestedClass"), Pattern.compile("^([\\w\\-_]+)\\.(kt|kts)$"), true);
            }
