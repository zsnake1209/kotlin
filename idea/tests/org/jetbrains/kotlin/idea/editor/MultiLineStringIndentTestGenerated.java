...
public class MultiLineStringIndentTestGenerated extends AbstractMultiLineStringIndentTest {
    ...
    @RunWith(JUnit3RunnerWithInners.class)
    public static class MultilineString extends AbstractMultiLineStringIndentTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class AfterUnmatchedBrace extends AbstractMultiLineStringIndentTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doTest, TargetBackend.ANY, testDataFilePath);
        }

        public void testAllFilesPresentInAfterUnmatchedBrace() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/editor/enterHandler/afterUnmatchedBrace"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.ANY, true);
        }
