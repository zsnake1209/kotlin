...
public class ProjectDescriptorWithStdlibSources extends KotlinWithJdkAndRuntimeLightProjectDescriptor {
    ...
    public void configureModule(@NotNull Module module, @NotNull ModifiableRootModel model) {
        ...
        modifiableModel.addRoot(VfsUtil.getUrlForLibraryRoot(new File("libraries/stdlib/jvm/src")), OrderRootType.SOURCES);
        modifiableModel.addRoot(VfsUtil.getUrlForLibraryRoot(new File("libraries/stdlib/common/src")), OrderRootType.SOURCES);
