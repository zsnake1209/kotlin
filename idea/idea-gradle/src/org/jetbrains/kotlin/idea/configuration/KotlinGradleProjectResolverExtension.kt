...
var DataNode<ModuleData>.enabledNewInference
        by CopyableDataNodeUserDataProperty(Key.create<Boolean>("KOTLIN_NEW_INFERENCE"))
...
class KotlinGradleProjectResolverExtension : AbstractProjectResolverExtension() {
    ...
    override fun populateModuleDependencies(
        ...
        ideModule.enabledNewInference = gradleModel.enabledNewInference
