...
public class NativeDefinitionsCCompoundStatementImpl extends ASTWrapperPsiElement implements NativeDefinitionsCCompoundStatement {

  public NativeDefinitionsCCompoundStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCBlockItemList getCBlockItemList() {
    return findChildByClass(NativeDefinitionsCBlockItemList.class);
  }
