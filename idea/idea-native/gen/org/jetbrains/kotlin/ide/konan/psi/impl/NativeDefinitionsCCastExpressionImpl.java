...
public class NativeDefinitionsCCastExpressionImpl extends ASTWrapperPsiElement implements NativeDefinitionsCCastExpression {

  public NativeDefinitionsCCastExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
