...
public class NativeDefinitionsCExclusiveOrExpressionAImpl extends NativeDefinitionsCExclusiveOrExpressionImpl implements NativeDefinitionsCExclusiveOrExpressionA {

  public NativeDefinitionsCExclusiveOrExpressionAImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NativeDefinitionsCAndExpression getCAndExpression() {
    return findNotNullChildByClass(NativeDefinitionsCAndExpression.class);
  }
