...
public class NativeDefinitionsCBlockItemImpl extends ASTWrapperPsiElement implements NativeDefinitionsCBlockItem {

  public NativeDefinitionsCBlockItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCStatement getCStatement() {
    return findChildByClass(NativeDefinitionsCStatement.class);
  }
