...
public abstract class NativeDefinitionsCAndExpressionImpl extends ASTWrapperPsiElement implements NativeDefinitionsCAndExpression {

  public NativeDefinitionsCAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
