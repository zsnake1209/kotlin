...
public class NativeDefinitionsCDesignatorImpl extends ASTWrapperPsiElement implements NativeDefinitionsCDesignator {

  public NativeDefinitionsCDesignatorImpl(@NotNull ASTNode node) {
    super(node);
  }
