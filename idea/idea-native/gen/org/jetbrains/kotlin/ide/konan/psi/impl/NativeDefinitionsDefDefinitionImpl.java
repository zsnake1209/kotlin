...
public class NativeDefinitionsDefDefinitionImpl extends ASTWrapperPsiElement implements NativeDefinitionsDefDefinition {

  public NativeDefinitionsDefDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NativeDefinitionsDefKey getDefKey() {
    return findNotNullChildByClass(NativeDefinitionsDefKey.class);
  }
