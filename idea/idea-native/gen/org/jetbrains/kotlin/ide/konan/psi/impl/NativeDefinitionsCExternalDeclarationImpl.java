...
public class NativeDefinitionsCExternalDeclarationImpl extends ASTWrapperPsiElement implements NativeDefinitionsCExternalDeclaration {

  public NativeDefinitionsCExternalDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public NativeDefinitionsCFunctionDefinition getCFunctionDefinition() {
    return findChildByClass(NativeDefinitionsCFunctionDefinition.class);
  }
