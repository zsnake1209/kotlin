...
public class NativeDefinitionsCTypeQualifierListAImpl extends NativeDefinitionsCTypeQualifierListImpl implements NativeDefinitionsCTypeQualifierListA {

  public NativeDefinitionsCTypeQualifierListAImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCTypeQualifier getCTypeQualifier() {
    return findNotNullChildByClass(NativeDefinitionsCTypeQualifier.class);
  }
