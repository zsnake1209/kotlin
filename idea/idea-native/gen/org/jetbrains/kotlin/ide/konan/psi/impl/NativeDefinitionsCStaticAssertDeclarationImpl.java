...
public class NativeDefinitionsCStaticAssertDeclarationImpl extends ASTWrapperPsiElement implements NativeDefinitionsCStaticAssertDeclaration {

  public NativeDefinitionsCStaticAssertDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCConstantExpression getCConstantExpression() {
    return findNotNullChildByClass(NativeDefinitionsCConstantExpression.class);
  }
