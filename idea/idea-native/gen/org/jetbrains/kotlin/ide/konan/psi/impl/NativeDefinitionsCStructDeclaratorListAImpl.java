...
public class NativeDefinitionsCStructDeclaratorListAImpl extends NativeDefinitionsCStructDeclaratorListImpl implements NativeDefinitionsCStructDeclaratorListA {

  public NativeDefinitionsCStructDeclaratorListAImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCStructDeclaratorList getCStructDeclaratorList() {
    return findNotNullChildByClass(NativeDefinitionsCStructDeclaratorList.class);
  }
