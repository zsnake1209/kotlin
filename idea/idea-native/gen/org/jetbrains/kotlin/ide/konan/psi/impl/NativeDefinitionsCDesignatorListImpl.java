...
public abstract class NativeDefinitionsCDesignatorListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCDesignatorList {

  public NativeDefinitionsCDesignatorListImpl(@NotNull ASTNode node) {
    super(node);
  }
