...
public abstract class NativeDefinitionsCEndImpl extends ASTWrapperPsiElement implements NativeDefinitionsCEnd {

  public NativeDefinitionsCEndImpl(@NotNull ASTNode node) {
    super(node);
  }
