...
public abstract class NativeDefinitionsCIdentifierListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCIdentifierList {

  public NativeDefinitionsCIdentifierListImpl(@NotNull ASTNode node) {
    super(node);
  }
