...
public abstract class NativeDefinitionsCEnumeratorListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCEnumeratorList {

  public NativeDefinitionsCEnumeratorListImpl(@NotNull ASTNode node) {
    super(node);
  }
