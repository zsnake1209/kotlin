...
public class NativeDefinitionsCTypeQualifierImpl extends ASTWrapperPsiElement implements NativeDefinitionsCTypeQualifier {

  public NativeDefinitionsCTypeQualifierImpl(@NotNull ASTNode node) {
    super(node);
  }
