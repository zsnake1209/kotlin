...
public class NativeDefinitionsCDeclaratorImpl extends ASTWrapperPsiElement implements NativeDefinitionsCDeclarator {

  public NativeDefinitionsCDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }
