...
public class NativeDefinitionsCStructOrUnionImpl extends ASTWrapperPsiElement implements NativeDefinitionsCStructOrUnion {

  public NativeDefinitionsCStructOrUnionImpl(@NotNull ASTNode node) {
    super(node);
  }
