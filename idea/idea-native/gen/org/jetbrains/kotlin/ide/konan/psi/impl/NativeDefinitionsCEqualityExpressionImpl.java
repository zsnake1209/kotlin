...
public abstract class NativeDefinitionsCEqualityExpressionImpl extends ASTWrapperPsiElement implements NativeDefinitionsCEqualityExpression {

  public NativeDefinitionsCEqualityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
