...
public class NativeDefinitionsCConstantExpressionImpl extends ASTWrapperPsiElement implements NativeDefinitionsCConstantExpression {

  public NativeDefinitionsCConstantExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCConditionalExpression getCConditionalExpression() {
    return findNotNullChildByClass(NativeDefinitionsCConditionalExpression.class);
  }
