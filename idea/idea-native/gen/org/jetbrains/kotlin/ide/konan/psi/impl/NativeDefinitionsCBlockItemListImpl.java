...
public abstract class NativeDefinitionsCBlockItemListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCBlockItemList {

  public NativeDefinitionsCBlockItemListImpl(@NotNull ASTNode node) {
    super(node);
  }
