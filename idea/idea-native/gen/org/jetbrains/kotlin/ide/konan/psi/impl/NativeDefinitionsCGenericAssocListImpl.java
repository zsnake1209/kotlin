...
public abstract class NativeDefinitionsCGenericAssocListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCGenericAssocList {

  public NativeDefinitionsCGenericAssocListImpl(@NotNull ASTNode node) {
    super(node);
  }
