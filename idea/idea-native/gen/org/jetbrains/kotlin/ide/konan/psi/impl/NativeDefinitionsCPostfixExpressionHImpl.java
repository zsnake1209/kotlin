...
public class NativeDefinitionsCPostfixExpressionHImpl extends NativeDefinitionsCPostfixExpressionImpl implements NativeDefinitionsCPostfixExpressionH {

  public NativeDefinitionsCPostfixExpressionHImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NativeDefinitionsCTypeName getCTypeName() {
    return findNotNullChildByClass(NativeDefinitionsCTypeName.class);
  }
