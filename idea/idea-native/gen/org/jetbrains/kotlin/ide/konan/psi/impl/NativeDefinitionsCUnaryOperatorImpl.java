...
public class NativeDefinitionsCUnaryOperatorImpl extends ASTWrapperPsiElement implements NativeDefinitionsCUnaryOperator {

  public NativeDefinitionsCUnaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
