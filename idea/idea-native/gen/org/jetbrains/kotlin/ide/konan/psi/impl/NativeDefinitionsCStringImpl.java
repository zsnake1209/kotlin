...
public class NativeDefinitionsCStringImpl extends ASTWrapperPsiElement implements NativeDefinitionsCString {

  public NativeDefinitionsCStringImpl(@NotNull ASTNode node) {
    super(node);
  }
