...
public class NativeDefinitionsCDirectDeclaratorLImpl extends NativeDefinitionsCDirectDeclaratorImpl implements NativeDefinitionsCDirectDeclaratorL {

  public NativeDefinitionsCDirectDeclaratorLImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NativeDefinitionsCIdentifierList getCIdentifierList() {
    return findNotNullChildByClass(NativeDefinitionsCIdentifierList.class);
  }
