...
public abstract class NativeDefinitionsCExpressionImpl extends ASTWrapperPsiElement implements NativeDefinitionsCExpression {

  public NativeDefinitionsCExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
