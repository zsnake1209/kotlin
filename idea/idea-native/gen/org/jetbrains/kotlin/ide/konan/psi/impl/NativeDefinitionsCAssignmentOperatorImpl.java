...
public class NativeDefinitionsCAssignmentOperatorImpl extends ASTWrapperPsiElement implements NativeDefinitionsCAssignmentOperator {

  public NativeDefinitionsCAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
