...
public abstract class NativeDefinitionsCTypeQualifierListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCTypeQualifierList {

  public NativeDefinitionsCTypeQualifierListImpl(@NotNull ASTNode node) {
    super(node);
  }
