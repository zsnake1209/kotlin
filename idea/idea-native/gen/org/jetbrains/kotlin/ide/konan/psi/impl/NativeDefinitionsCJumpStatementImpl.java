...
public class NativeDefinitionsCJumpStatementImpl extends ASTWrapperPsiElement implements NativeDefinitionsCJumpStatement {

  public NativeDefinitionsCJumpStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
