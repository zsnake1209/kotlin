...
public abstract class NativeDefinitionsCDeclarationListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCDeclarationList {

  public NativeDefinitionsCDeclarationListImpl(@NotNull ASTNode node) {
    super(node);
  }
