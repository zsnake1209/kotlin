...
public abstract class NativeDefinitionsCInitializerListImpl extends ASTWrapperPsiElement implements NativeDefinitionsCInitializerList {

  public NativeDefinitionsCInitializerListImpl(@NotNull ASTNode node) {
    super(node);
  }
