    ...
    private class NewLoadConfigurationNotificationPanel(
        ...
        init {
            ...
            createComponentActionLabel(KotlinIdeaCoreBundle.message("notification.action.text.enable.auto.reload")) {
                ...
                val order = ScriptDefinitionsManager.getInstance(project).getAllDefinitions().indexOf(scriptDefinition)
                KotlinScriptingSettings.getInstance(project).setAutoReloadConfigurations(order, scriptDefinition, true)
            }
        }
