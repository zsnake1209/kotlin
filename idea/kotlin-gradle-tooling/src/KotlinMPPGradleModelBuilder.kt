...
class KotlinMPPGradleModelBuilder : ModelBuilderService {
    ...
    private fun buildLanguageSettings(gradleLanguageSettings: Any): KotlinLanguageSettings? {
        ...
        val getExperimentalAnnotationsInUse = languageSettingsClass.getMethodOrNull("getExperimentalAnnotationsInUse") ?: return null
        @Suppress("UNCHECKED_CAST")
        return KotlinLanguageSettingsImpl(
            ...
            getExperimentalAnnotationsInUse(gradleLanguageSettings) as? Set<String> ?: emptySet()
        )
    }
