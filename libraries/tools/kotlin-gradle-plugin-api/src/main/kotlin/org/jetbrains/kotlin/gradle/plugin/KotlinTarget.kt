...
interface KotlinTargetWithTests<T : KotlinTargetTestRun<out KotlinExecution.ExecutionSource>> : KotlinTestable<T>, KotlinTarget {
    companion object {
        const val DEFAULT_TEST_RUN_NAME = KotlinTestable.DEFAULT_TEST_RUN_NAME
    }
}