...
import org.jetbrains.kotlin.gradle.internal.CompilerArgumentsGradleInput
...
open class Kotlin2JsCompile : AbstractKotlinCompile<K2JSCompilerArguments>(), KotlinJsCompile {
    ...
    override val compilerArgumentsContributor: CompilerArgumentsContributor<K2JSCompilerArguments> by project.provider {
        KotlinJsCompilerArgumentsContributor(thisTaskProvider)
    }
