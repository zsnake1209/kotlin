...
internal abstract class KotlinSourceSetProcessor<T : AbstractKotlinCompile<*>>(
    ...
    private fun registerKotlinCompileTask(): TaskProvider<out T> {
        ...
        return doRegisterTask(project, name) {
            ...
            kotlinCompilation.output.addClassesDir { project.files(kotlinTask.get().destinationDir).builtBy(kotlinTask) }
        }
    }
...
internal class Kotlin2JvmSourceSetProcessor(
    ...
    override fun doRegisterTask(project: Project, taskName: String, configureAction: (KotlinCompile)->(Unit)): TaskProvider<out KotlinCompile> =
...
internal class KotlinCommonSourceSetProcessor(
    ...
    override fun doRegisterTask(project: Project, taskName: String, configureAction: (KotlinCompileCommon) -> (Unit)): TaskProvider<out KotlinCompileCommon> =
