...
class KotlinNativeTargetWithTestsConfigurator(kotlinPluginVersion: String)
    ...
    KotlinTargetWithTestsConfigurator<KotlinNativeCompilation, KotlinNativeBinaryTestRun, KotlinNativeTargetWithTests> {

    override val testRunClass: Class<KotlinNativeBinaryTestRun>
        get() = KotlinNativeBinaryTestRun::class.java

    override fun configureTest(target: KotlinNativeTargetWithTests) {
