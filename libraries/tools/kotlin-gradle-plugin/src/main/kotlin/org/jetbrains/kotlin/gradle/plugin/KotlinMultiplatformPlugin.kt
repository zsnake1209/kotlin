...
internal fun platformImplementationConfigName(platform: String) = "platform${platform.capitalize()}Implementations"
...
open class KotlinPlatformImplementationPluginBase(platformName: String) : KotlinPlatformPluginBase(platformName) {
    ...
    override fun apply(project: Project) {
        ...
        PlatformModuleDependenciesCompletion(platformName).runForPlatformProject(project)
    }
