...
internal interface KotlinTargetWithTestsConfigurator<C : KotlinCompilation<*>, R : KotlinTargetTestRun, T : KotlinTargetWithTests<R>>
    ...
    fun configureTest(target: T) {
        ...
        target.testRuns.create(KotlinTestRun.DEFAULT_TEST_RUN_NAME)
    }
