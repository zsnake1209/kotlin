...
class KotlinJvmTargetConfigurator(kotlinPluginVersion: String) :
    ...
    KotlinTargetWithTestsConfigurator<KotlinJvmCompilation, KotlinJvmTestRun, KotlinJvmTarget> {
    ...
    override fun createTestRun(
        ...
        testTask = testTaskOrProvider.getTaskOrProvider() as TaskProvider<KotlinJvmTest>

        val testCompilation = target.compilations.getByName(KotlinCompilation.TEST_COMPILATION_NAME)

        setTestSourceFromCompilation(testCompilation)
