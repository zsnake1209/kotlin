...
class VariantAwareDependenciesIT : BaseGradleIT() {
    ...
    fun testConfigurationsWithNoExplicitUsageResolveRuntime() =
        // Starting with Gradle 5.0, plain JAR dependencies have two variants, and resolving them to the API one leads to transitive
        // dependencies left out of the resolution results. We need to ensure that our attributes schema does not lead to the API variants
        // chosen over the runtime ones:
