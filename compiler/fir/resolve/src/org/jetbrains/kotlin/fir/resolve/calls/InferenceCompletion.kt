...
private fun Candidate.hasProperNonTrivialLowerConstraints(components: InferenceComponents, typeVariable: ConeKotlinType): Boolean {
    ...
    val context = system as TypeSystemInferenceExtensionContext
    val constructor = with(context) { typeVariable.typeConstructor() }
    ...
    return constraints.isNotEmpty() && constraints.all {
        !components.trivialConstraintTypeInferenceOracle.isTrivialConstraint(it) &&
