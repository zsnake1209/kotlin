...
public class A {
    ...
    public Integer baz(@DefaultValue(value = "42") Integer x) { return x; }
}
...
public interface AInt {
    public Integer foo(@DefaultValue(value = "42") Integer x);
...
public class C extends A {
    public Integer foo(@DefaultValue(value = "42") Integer x) { return x; }
