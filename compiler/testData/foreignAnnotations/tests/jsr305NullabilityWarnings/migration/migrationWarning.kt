...
// JSR305_GLOBAL_REPORT enable
// JSR305_MIGRATION_REPORT warn
// JSR305_SPECIAL_REPORT MyNullable:ignore, MyMigrationNullable:enable
...
public class A {
    ...
    @MyMigrationNullable
    public String foo(@MyMigrationNonnull String x, @CheckForNull CharSequence y) {
        return "";
    }
    ...
    @MyNullable
    public String foo2(@MyNonnull String x, @CheckForNull CharSequence y) {
        return "";
    }
