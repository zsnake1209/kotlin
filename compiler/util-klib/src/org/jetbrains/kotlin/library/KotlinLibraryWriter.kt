...
//class TopLevelDeclaration(override val id: Long, isLocal: Boolean, override val declarationName: String, override val bytes: ByteArray) :
//    SerializedDeclaration() {
//    override val local = if (isLocal) 1 else 0
//    override val size = bytes.size
//}

class TopLevelDeclarationX(override val id: Int, override val declarationName: String, override val bytes: ByteArray) :
    SerializedDeclaration() {
    override val size = bytes.size
}
