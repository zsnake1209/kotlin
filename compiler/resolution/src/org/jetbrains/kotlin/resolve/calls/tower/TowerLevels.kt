...
// This level provides only extension properties on types' member scopes.
// Currently, there is only one kind of these properties: synthetic java property.
// Contract for the tower level: accept extension receiver, return properties.
...
private fun ResolutionScope.getContributedFunctionsAndConstructors(
    ...
    val synthetic =
        syntheticScopes.provideSyntheticScope(this, SyntheticScopesRequirements(needStaticFunctions = true, needConstructors = true))
