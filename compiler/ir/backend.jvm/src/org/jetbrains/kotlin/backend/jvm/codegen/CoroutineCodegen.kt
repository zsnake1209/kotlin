...
internal fun MethodNode.acceptWithStateMachine(
    ...
    val element = if (irFunction.isSuspend)
        irFunction.symbol.wrappedDescriptor.psiElement ?: classCodegen.irClass.wrappedDescriptor.psiElement
    else
        classCodegen.context.suspendLambdaToOriginalFunctionMap[classCodegen.irClass.attributeOwnerId]!!.symbol.wrappedDescriptor.psiElement
