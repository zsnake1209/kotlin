...
class JvmIrDeserializer(
    ...
    override fun getDeclaration(symbol: IrSymbol, backoff: (IrSymbol) -> IrDeclaration): IrDeclaration {
        ...
        if (toplevelDescriptor is ClassDescriptor) {
            ...
            val facadeClass = buildFacadeClass(irProto).also {
    ...
    private fun buildFacadeClass(proto: JvmIr.JvmIrFile): IrClass = buildClass {
        origin = IrDeclarationOrigin.FILE_CLASS
        name = FqName(proto.facadeFqName).shortName()
    }.apply {
