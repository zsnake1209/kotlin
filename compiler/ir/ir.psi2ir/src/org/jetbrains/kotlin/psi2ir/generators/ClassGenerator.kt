...
class ClassGenerator(
    ...
    private fun generateDelegatedImplementationMembers(
        ...
        for (delegatedMember in delegatedMembers) {
            ...
            if (overriddenMember != null) {
                val delegateToMember =
                    delegatesMap[delegatedMember]
        ...
        when (delegatedMember) {
            is FunctionDescriptor ->
                generateDelegatedFunction(
                    irClass, irDelegate, delegatedMember,
                    delegateToMember as FunctionDescriptor
                )
            is PropertyDescriptor ->
                generateDelegatedProperty(
                    irClass, irDelegate, delegatedMember,
                    delegateToMember as PropertyDescriptor
                )
        }
    ...
    private fun generateDelegatedProperty(
        ...
        irProperty.getter =
            generateDelegatedFunction(
                irDelegate,
                delegatedDescriptor.getter!!, delegateToDescriptor.getter!!
            )
        ...
        if (delegatedDescriptor.isVar) {
            irProperty.setter =
                generateDelegatedFunction(
                    irDelegate,
                    delegatedDescriptor.setter!!, delegateToDescriptor.setter!!
                )
        }
        return irProperty
    }
    ...
    private fun generateDelegatedFunction(
        ...
        context.symbolTable.declareSimpleFunctionWithOverrides(
            ...
            irFunction.body =
                generateDelegateFunctionBody(irDelegate, delegatedDescriptor, delegateToDescriptor, irFunction)
        }
