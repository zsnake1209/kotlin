...
import org.jetbrains.kotlin.backend.common.serialization.GlobalDeclarationTableX
...
class JsUniqIdClashTrackerX : IdSignatureClashTracker {
...
class JsGlobalDeclarationTableX(signatureSerializer: IdSignatureSerializer, builtIns: IrBuiltIns) :
    GlobalDeclarationTableX(signatureSerializer, JsManglerIr, JsUniqIdClashTrackerX()) {
    init {
