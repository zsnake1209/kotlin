...
fun IrBuilderWithScope.irImplicitDynamicCast(argument: IrExpression, type: IrType) =
    IrTypeOperatorCallImpl(startOffset, endOffset, type, IrTypeOperator.IMPLICIT_DYNAMIC_CAST, type, argument)
