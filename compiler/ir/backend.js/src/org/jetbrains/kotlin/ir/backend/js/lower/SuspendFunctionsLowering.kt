...
internal class SuspendFunctionsLowering(val context: JsIrBackendContext): DeclarationContainerLoweringPass {
    ...
    private val coroutinesScope           = context.module.getPackage(COROUTINES_FQ_NAME).memberScope
    private val kotlinPackageScope        = context.module.getPackage(KOTLIN_FQ_NAME).memberScope
