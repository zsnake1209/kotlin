...
class StateMachineBuilder(
    ...
    private fun implicitDynamicCast(value: IrExpression, toType: IrType) =
        JsIrBuilder.buildImplicitDynamicCast(value, toType)
    ...
    override fun visitCall(expression: IrCall) {
        ...
        if (expression.isSuspend) {
            ...
            addStatement(JsIrBuilder.buildSetVariable(suspendResult, implicitDynamicCast(result, anyN), unit))
//            addStatement(JsIrBuilder.buildSetVariable(suspendResult, result, unit))
            ...
            addStatement(implicitDynamicCast(JsIrBuilder.buildGetValue(suspendResult), functionReturnType))
//            addStatement(implicitCast(JsIrBuilder.buildGetValue(suspendResult), expression.type))
    ...
    private fun buildUnboxingState(unboxState: SuspendState, continueState: SuspendState, expectedType: IrType) {
        ...
        addStatement(tmp)
        addStatement(JsIrBuilder.buildSetVariable(suspendResult, implicitDynamicCast(JsIrBuilder.buildGetValue(tmp.symbol), anyN), anyN))
