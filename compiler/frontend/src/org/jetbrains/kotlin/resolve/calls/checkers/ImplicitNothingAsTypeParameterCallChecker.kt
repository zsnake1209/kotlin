...
object ImplicitNothingAsTypeParameterCallChecker : CallChecker {
    ...
    private fun getSubResolvedAtomsToAnalyze(
        ...
        val resolvedAtomsFromExtensionReceiver = resolvedCall.resolvedCallAtom.extensionReceiverArgument?.run {
            getSubResolvedAtomsToAnalyze(
                psiExpression.getResolvedCall(bindingContext) ?: return@run null,
