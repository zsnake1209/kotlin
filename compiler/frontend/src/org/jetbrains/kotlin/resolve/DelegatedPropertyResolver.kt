...
class DelegatedPropertyResolver(
    ...
    fun getGetValueMethodReturnType(
        ...
        return resolvedCall?.run { resultingDescriptor.returnType }
    }
    ...
    private fun createContextForGetSetValueMethods(
        ...
        ExpressionTypingContext.newContext(
            trace,
            ScopeUtils.makeScopeForDelegateConventionFunctions(scopeForDelegate, propertyDescriptor),
    ...
    private fun getProvideDelegateMethod(
        ...
        val context = ExpressionTypingContext.newContext(
            trace, initializerScope, dataFlowInfo, NO_EXPECTED_TYPE,
    ...
    inner class ConstraintSystemCompleterImpl(
        ...
        private val variableDescriptor: VariableDescriptorWithAccessors,
        private val delegateExpression: KtExpression,
        private val scopeForDelegate: LexicalScope,
        private val trace: BindingTrace,
        private val dataFlowInfo: DataFlowInfo
