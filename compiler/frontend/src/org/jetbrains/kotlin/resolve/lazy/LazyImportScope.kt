...
import org.jetbrains.kotlin.resolve.annotations.KOTLINE_NATIVE_THROWS_ANNOTATION_FQ_NAME
...
class LazyImportScope(
    ...
    private fun ClassifierDescriptor.isKotlinOrNativeThrows(): Boolean {
        ...
        return isKotlinThrows() || fqNameOrNull() == KOTLINE_NATIVE_THROWS_ANNOTATION_FQ_NAME
    }
