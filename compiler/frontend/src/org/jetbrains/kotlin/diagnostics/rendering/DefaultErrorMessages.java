...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(IMPLICIT_NOTHING_TYPE_ARGUMENT_AGAINST_NOT_NOTHING_EXPECTED_TYPE, "Returning type parameter has been inferred to Nothing implicitly because Nothing is more specific than specified expected type. Please, specify type arguments explicitly with respect to expected type to hide this warning. Nothing can produce an exception at runtime.");
