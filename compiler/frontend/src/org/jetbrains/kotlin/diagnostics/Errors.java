...
public interface Errors {
    ...
    DiagnosticFactory2<PsiElement, NewTypeVariable, ContradictoryTypeVariableError> CONTRADICTION_IN_CONSTRAINT_SYSTEM = DiagnosticFactory2.create(ERROR);
    DiagnosticFactory2<PsiElement, ContradictoryTypeVariableError, SpecialTypeVariableKind> CONTRADICTION_FOR_SPECIAL_CALL = DiagnosticFactory2.create(ERROR);
