...
public class ImplementationBodyCodegen extends ClassBodyCodegen {
    ...
    private ArgumentGenerator generateSuperCallImplicitArguments(
        ...
        if (isAnonymousObject(descriptor)) {
            ...
            return new ObjectSuperCallArgumentGenerator(superValues, iv, offset, superConstructor.getValueParameters(), codegen.typeMapper);
        }
        else {
    ...
    private static class ObjectSuperCallArgumentGenerator extends ArgumentGenerator {
        ...
        protected void generateDefaultJava(int i, @NotNull DefaultValueArgument argument) {
            Type type = parameters.get(i).getAsmType();
            StackValue argumentValue = StackValueKt.findJavaDefaultArgumentValue(superValueParameters.get(i), type, typeMapper);
