...
public abstract class StackValue {
    ...
    private static StackValue putLocalSuspendFunctionOnStack(
        ...
        // 3) recursive call: we are in the middle of defining it, but, thankfully, we can call `this,invoke` to simply
        ...
        if (codegen.context.hasThisDescriptor()) {
            ...
            if (thisDescriptor instanceof SyntheticClassDescriptorForLambda &&
                ...
                // Call inside of a callable reference
                // if it call to recursive local, just return this$0
