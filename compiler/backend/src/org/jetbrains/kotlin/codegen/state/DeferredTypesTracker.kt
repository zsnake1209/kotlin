...
interface DeferredTypesTracker {
    ...
    object Throwing : DeferredTypesTracker {
        override val isValid get() = false
...
class ReturnConstantValueDeferredTypeTracker(private val constant: String) : DeferredTypesTracker {
    override val isValid get() = true
    ...
    override fun getDeferredTypeInfoComputation(typeText: String): Function0<DeferredTypesTracker.TypeInfo>? = null
}
