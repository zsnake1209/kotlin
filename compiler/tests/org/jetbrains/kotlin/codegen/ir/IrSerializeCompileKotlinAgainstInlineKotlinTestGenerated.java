...
public class IrSerializeCompileKotlinAgainstInlineKotlinTestGenerated extends AbstractIrSerializeCompileKotlinAgainstInlineKotlinTest {
    private void runTest(String testDataFilePath) throws Exception {
        KotlinTestUtils.runTest(this::doTest, TargetBackend.JVM_IR_SERIALIZE, testDataFilePath);
    }
    ...
    public static class Suspend extends AbstractIrSerializeCompileKotlinAgainstInlineKotlinTest {
        ...
        private void runTestWithPackageReplacement(String testDataFilePath, String packageName) throws Exception {
            KotlinTestUtils.runTest(filePath -> doTestWithCoroutinesPackageReplacement(filePath, packageName), TargetBackend.JVM_IR_SERIALIZE, testDataFilePath);
        }
