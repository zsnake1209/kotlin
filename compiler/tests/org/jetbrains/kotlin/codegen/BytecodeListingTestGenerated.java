...
public class BytecodeListingTestGenerated extends AbstractBytecodeListingTest {
    ...
    public static class Coroutines extends AbstractBytecodeListingTest {
        ...
        @TestMetadata("suspendLambdaTco.kt")
        public void testSuspendLambdaTco_1_2() throws Exception {
            runTestWithPackageReplacement("compiler/testData/codegen/bytecodeListing/coroutines/suspendLambdaTco.kt", "kotlin.coroutines.experimental");
        }

        @TestMetadata("suspendLambdaTco.kt")
        public void testSuspendLambdaTco_1_3() throws Exception {
            runTestWithPackageReplacement("compiler/testData/codegen/bytecodeListing/coroutines/suspendLambdaTco.kt", "kotlin.coroutines");
        }
