...
class Case1(){
    ...
    fun case1() {
        <!DEBUG_INFO_CALL("fqName: libPackageCase1Explicit.listOf; typeCall: extension function")!>listOf(elements1= arrayOf(1))<!>
    }
}
...
class Case2(){
    ...
    fun case1() {
        <!DEBUG_INFO_CALL("fqName: libPackageCase2Explicit.listOf; typeCall: extension function")!>listOf(elements1= arrayOf(1))<!>
    }
}
