...
internal fun KtUltraLightSupport.findAnnotation(
    owner: KtAnnotated,
    fqName: FqName
): Pair<KtAnnotationEntry, AnnotationDescriptor>? {
    ...
    for (entry in candidates) {
        val descriptor = entry.analyze().get(BindingContext.ANNOTATION, entry)
